...
from .views.reinitialisation_views import DemandeReinitialisationMotDePasseView, ReinitialisationMotDePasseView
...
urlpatterns = [
    ...
    path('reinitialisation/', ReinitialisationMotDePasseView.as_view(),
